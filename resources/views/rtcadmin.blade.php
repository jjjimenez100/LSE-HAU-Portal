    ...
    <div class="row">
        <div class="col-md-8 hidden" id="videoroom">
            <form class="form-inline">
                ...
                <div class="form-group">
                    <button class="btn btn-success" id="open" style="margin: 5%"><i class="fa fa-plus-square" aria-hidden="true"></i> Create Room</button>
                </div>
                <div class="form-group">
